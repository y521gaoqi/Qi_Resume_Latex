...
\cvevent{Android Developer}{IQIYI.com Inc}{Summer, 2017}{Beijing, China}
\begin{itemize}
\item Researched on daemon process and wrote a demonstration to prevent the program from being shut down.
\smallskip
\item Wrote a demonstration to marquee effect.
\smallskip
\item Tested functions of video platform basing on different TV boxes.
\end{itemize}
...
\begin{itemize}
    \item Languages: Java, C++, Python, SQL
    \smallskip
    ...
    \smallskip
    \item Network: TCP/IP protocol, http/https
    \smallskip
...
\smallskip
\begin{description}
  \item[$\bullet$] English \hspace{0.64cm} {$\bullet$}\hspace{0.1cm} Mandarin
\end{description}
